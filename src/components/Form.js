            ...
            <>
                  <div className="form-group row">
                    <div className="col-sm-10">
                      ...
                      <button type="button" onClick={() =>{ this.props.addTodo(this.state.todotext,this.state.minute,this.state.second,this.state.timeBonus); this.setState({ todotext: '',timeStart:'',timeBonus:''}) } } style={{marginTop: "25px"}} className="btn btn-success">Add Todo</button>
                    </div>
                  </div>
            </>
        );
